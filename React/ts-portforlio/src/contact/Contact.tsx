export default function Contact(){
    return (
        ...
        text-text-dark">
            <h2 className="text-3xl font-medium">Contacta conmigo!</h2>
            <div className="flex flex-row justify-between px-15">
                <div>
                    <p className="w-2/5 text-2xl text-text-dark">
                        Escribeme y me pondre en contacto contigo
                        lo mas pronto posible.
                    </p>
                </div>
                <div className="text-2xl">
                    <h5 className="text-primary-green">Aqui tienes mi correo!</h5>
            ...
            <div className="flex gap-10 justify-end items-center px-15">                <h5>Te dejo mis redes aqui</h5>
