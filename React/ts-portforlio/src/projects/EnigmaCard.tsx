...
export default function EnigmaCard() {
    ...
    return (
        <article className="bg-surface-background col-span-1 md:col-span-2 lg:col-span-3
        ...
        hover:scale-101 ">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 w-full justify-evenly p-5">
