...
export default function Header() {
    ...
    return (
        ...
        fixed top-0 w-screen h-auto md:h-17 px-5 md:px-10 py-3 z-502
        ...
        ">
            ...
            <div className="flex gap-5 items-center w-full justify-between md:w-auto md:justify-end">
                ...
                <label className="inline-flex items-center relative cursor-pointer">
                    <input className="peer hidden" id="toggle" type="checkbox" checked={theme === 'dark'} onChange={toggleTheme} />
                    <div
                        className="relative w-[88px] h-[40px] bg-white peer-checked:bg-zinc-500 rounded-full after:absolute after:content-[''] after:w-[32px] after:h-[32px] after:bg-gradient-to-r from-orange-500 to-yellow-400 peer-checked:after:from-zinc-900 peer-checked:after:to-zinc-900 after:rounded-full after:top-[4px] after:left-[4px] active:after:w-[40px] peer-checked:after:left-[84px] peer-checked:after:translate-x-[-100%] shadow-sm duration-300 after:duration-300 after:shadow-md"
                    ></div>
                    <svg
                        height="0"
                        width="100"
